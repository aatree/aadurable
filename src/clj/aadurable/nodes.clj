...
(definterface IFactory
  ...
  (instanceClass [])
  (qualified [t2 opts])
  (sval [^aadurable.nodes.INode inode opts])
  (valueLength [^aadurable.nodes.INode node
                opts])
  (deserialize [^aadurable.nodes.INode node
                ^java.nio.ByteBuffer buffer
                opts])
  (writeValue [^aadurable.nodes.INode node
               ^java.nio.ByteBuffer buffer
               opts])
  (valueNode [^aadurable.nodes.INode node
              opts]))
